...
public class ExerciseData {
    public ExerciseData() {
        ...
        descriptions.put("1", Arrays.asList(
        ...
        descriptions.put("2", Arrays.asList(
                "1: Дана строка sql-запроса \"select * from students WHERE \". Сформируйте часть WHERE этого запроса, используя StringBuilder. Данные для фильтрации приведены ниже в виде json-строки. Если значение null, то параметр не должен попадать в запрос.\nString input_str = \"{\"name\":\"Ivanov\", \"country\":\"Russia\", \"city\":\"Moscow\", \"age\":\"null\"}\" Ввод данных: {\"name\":\"Ivanov\", \"country\":\"Russia\", \"city\":\"Moscow\", \"age\":\"null\"} вывод: select * from students WHERE name=Ivanov AND country=Russia AND city=Moscow",
        ...
        descriptions.put("3", Arrays.asList(
