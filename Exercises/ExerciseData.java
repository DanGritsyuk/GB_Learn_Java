...
public class ExerciseData {
    public ExerciseData() {
        ...
        descriptions.put("ДОМАШНЯЯ РАБОТА 4", Arrays.asList(
                "Задание 1: Даны два Deque, представляющие два целых числа. Цифры хранятся в обратном порядке и каждый из их узлов содержит одну цифру.\n1) Умножьте два числа и верните произведение в виде связанного списка.\n2) Сложите два числа и верните сумму в виде связанного списка.\nОдно или два числа могут быть отрицательными.",
                "Задание 2: Даны два Deque, цифры в обратном порядке.\n[3,2,1,-] - пример Deque\n[5,4,3]- пример второго Deque\n1) -123 * 345 = -42 435\nОтвет всегда - связный список, в обычном порядке\n[-,4,2,4,3,5] - пример ответа"));
